...
<div style="padding-left:800px;padding-right:80px;">
  ...
  <a href="allevents" data-toggle="tooltip" title="" class="btn btn-success btn-xs" data-original-title="View"><h5>ALL EVENTS</h5></a>
			...
			<form action="<?php echo base_url()?>addevent" method="post">
				
				<div class="form-group custom-bottom-margin">
					<label class="control-label col-sm-4 text-right" for="name">Name</label>
					<div class="col-sm-5">
					  <input type="text" name="name" class="form-control" value="" placeholder="Enter name" id="name">
					</div>
				</div>
				...
				<div class="form-group custom-bottom-margin">
					...
					<div class="col-sm-5">
					  <input type="text" name="description" class="form-control" placeholder="Enter description" id="description" required>
					</div>
				</div>
			...
			<div class="form-group custom-bottom-margin">
					...
					<div class="col-sm-5">
					  <input type="text"  name="location" class="form-control" value="" placeholder="Confirm location" id="location" required >
					</div>
				</div>
...
<div class="form-group custom-bottom-margin">
              <label class="control-label col-sm-4 text-right" for="event_date">Confirm event_date</label>
					<div class="col-sm-5">
				<input type="text" class="form-control" id="datepicker" name="event_date" autocomplete="off" required>
                </div>
                <!-- /.input group -->
              </div>
